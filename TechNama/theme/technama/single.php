        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('tn-single-article'); ?>>
                ...
                <div class="tn-single-content-wrapper">
                    ...
                    <a href="https://wa.me/?text=<?php echo esc_attr(get_the_title()); ?>%20<?php echo esc_url(get_permalink()); ?>"
...
<div class="tn-ad-slot tn-ad-inarticle">
    ...
    <script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
		...
		<?php
		$related_posts = technama_get_related_posts(get_the_ID(), 3);
		if ($related_posts->have_posts()) :
		?>
			<div class="related-posts">
				<h3><?php esc_html_e('Related Articles', 'technama'); ?></h3>
